    ...
    <div className="user_s_Box"style={{marginLeft: "0",marginTop:"20px",marginBottom:"0",marginRight:"0",paddingLeft:"0",paddingTop:"0",paddingRight:"0",paddingBottom:"0" }}>
      <div className="Each_user_details_box"style={{marginLeft: "0",marginTop:"20px",marginBottom:"0",marginRight:"0",paddingLeft:"0",paddingTop:"0",paddingRight:"0",paddingBottom:"0" }}>
        <div className="_user_box">
          <p>547030</p>
          <img src="Ellipse 14 (11).png" alt="#" className="users-cards" style={{ marginTop: "0px" }}></img>
          <br></br>
          <p>Science Student</p>
        </div>

        <div className="cap-phone-comment-box">
          <img src="img11.png" alt="#" className="icons_size"></img>
          <img src="Frame 30086.png" alt="#" className="icons_size"></img>
          <img src="Frame 30087.png" alt="#" className="icons_size"></img>
        </div>

        <div className="star-icons">
          <img src="image 6.png" alt="#" className="icons-star"></img>
          <img src="image 6.png" alt="#" className="icons-star"></img>
          <img src="image 6.png" alt="#" className="icons-star"></img>
          <img src="image 6.png" alt="#" className="icons-star"></img>
          <img src="image 10.png" alt="#" className="icons-star"></img>
        </div>
