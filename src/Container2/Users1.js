...
function Users1(props) {
  return (
    <div className="user_s_Box"style={{margin:"0 0",padding:"0 0"}}>
      <div className="Each_user_details_box"style={{margin:"20px 0 0 0",padding:"5px 0" }} >
        <div className="_user_box">
          <p>{props.selectedUser._id}</p>
          <img src={ Ellipse14_8} alt="##" className="users-cards" style={{ marginTop: "0px" }}></img>
          <br></br>
          <p>Science Student</p>
        </div>
